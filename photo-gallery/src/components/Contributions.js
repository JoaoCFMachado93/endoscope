  ...
  return (
    <div className="contributions">
      ...
      <div className="contributions-text">
        ...
        <p>
        ScopeView is a project designed for the endoscopic community, with the goal of growing and evolving through its engagement. To contribute, please submit your images with the following details: caption, indication of histological confirmation (when applicable), clinical name, and hospital of the submitter.          </p>
